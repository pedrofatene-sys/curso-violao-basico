...
const channels = [
    { id: '-oT2SfILGCY', name: 'Introdução' },
    { id: 'yB9AqmAI9g0', name: 'Notas e oitavas?' },
    { id: 'Ruv4gyxcl-s', name: 'Afinando o violão' },
    { id: '79FfQdFf1mc', name: 'Tempo e Compasso' },
    { id: '8XHafoUWm98', name: 'Destravando os Dedos I' },
    { id: 'ehHQiPHirHA', name: 'Primeiros acordes' },
    { id: 'RRDFTygve1M', name: 'Pra não dizer que não falei das flores' },
    { id: 'X7cQw5lj4iM', name: 'Garota Nacional' },
    { id: 'nppz4Wq-D_E', name: 'Lá Maior e Mi Maior' },
    { id: 'f_Vlmy9uGdc', name: 'Início ao dedilhado' },
    { id: '1MndeduC9fQ', name: 'Asa Branca' },
    { id: '1nOd4FcVoj4', name: 'Destravando os Dedos II' },
    { id: 'cAxs0WA7uhA', name: 'Flores' },
    { id: 'EDT-5ykwHm4', name: 'Parabéns Pra Você' },
    { id: '855K3-RBeAc', name: 'Pestana' },
    { id: 'epUtlcS7mYs', name: 'Tocando em Frente' }    
];
